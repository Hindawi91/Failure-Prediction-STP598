...
print ("number of failures in train set = ",np.count_nonzero(y_train == 1))
print ("number of failures in test set = ",np.count_nonzero(y_test == 1))
...
make_ROC("GradientBoost")    
firas_tests("GradientBoost",y_true, y_pred)
