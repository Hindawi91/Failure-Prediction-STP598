...
params = {'hidden_layer_sizes': [(100,),(200,),(300,),
                                 ...
                                 (100,100,100),(200,200,200),(300,300,300),(100,200,300)],
...
search_1 = GridSearchCV(imba_pipeline, param_grid=new_params , cv=kf, scoring = "balanced_accuracy",verbose = 2,
                             n_jobs=-1)
